...
import { financeApi, type FinanceSummary, type PnlTrendPoint, type ProductMarginItem } from '../../api/finance';
...
export default function ReportsPage() {
  ...
  const thirtyDaysAgoIso = toIsoDate(new Date(Date.now() - 29 * 24 * 60 * 60 * 1000));
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Financial Analysis (Phase 8)</h1>
      <p className="text-gray-500 mb-6">COGS, margins, and profit &amp; loss analytics from real sales and wastage data</p>
